            ...
            <header className=' pt-2 flex justify-end absolute w-full h-16 '>
                <nav className='  w-1/3'>
                    <ul className=' w-full flex justify-end items-center'>   
                        <Link className=' mr-4 shadow-xl transition-all bg-neutral-800 text-white text-xl w-1/2 py-4 px-2 rounded hover:rounded-3xl font-bold cursor-pointer text-center ' to={'/cadastro'}><li>Cadastre-se</li></Link>
                    </ul>
                </nav>
            </header>
            <div className=' h-1/2'>
