...
export default function PaginaInicial() {
    ...
    return (
        <main className=" overflow-hidden flex flex-col h-screen text-gray-500 bg-gradient-to-b from-gray-50 via-gray-100 to-gray-200">
            ...
            <div className=' md:overflow-hidden w-full flex flex-col md:flex-row h-1/2 '>
